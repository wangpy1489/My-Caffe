...
os.chdir(caffe_root)
# 标记训练和测试图片
# os.system('./create_lablefile.sh')
#转换图片格式
os.system('./crate_lmdb.sh') 
#计算均值
os.system(' sudo build/tools/compute_image_mean examples/myfile/img_train_lmdb examples/myfile/mean.binaryproto')
#创建模型
...
# solver_file(‘example/Myfile’, clothes)


#开始训练
os.system('sudo build/tools/caffe train -solver examples/myfile/solver.prototxt')
print("All finished.")